( function( $ ){
	...
	$( function() {
		...
		editCustomPermalink = function( post_id ) {
			...
			var s = $( '#sample-permalink' ), revert_s = s.html(), real_slug = $( '#cf_page_permalink' ), revert_slug = real_slug.val(), b = $( '#customise-permalink-buttons' ), revert_b = b.html();
